"""
Django settings for araza_shop project.
...
SECRET_KEY = 'django-insecure-5#&i)yv&l)!tm2$w$4g82jh@!r217dtwf4%*ha9@*r%n0z(bof'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'wallet_static.wallet.get_wallet',
                'wallet_static.wallet.get_category'
            ],
        },
    },
]
